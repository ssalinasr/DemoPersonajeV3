...
public class Frame extends javax.swing.JFrame {
    ...
    private void BtnLeerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLeerActionPerformed
        Imagen b = new Imagen();
        //try{
        //ImageIcon k = new ImageIcon(getClass().getResource(this.TextCadena.getText()));
        //this.LblImagen.setIcon(k);
        //String [] q = this.TextCadena.getText().split("\\.");
        b.leerImagen(this.LblImagen,this.TextCadena.getText());
        //}catch(Exception e){
           // String [] q = this.TextCadena.getText().split("\\.");
            //b.leerImagen(q[1],this.LblImagen,this.TextCadena.getText());
            //JOptionPane.showMessageDialog(null,"ese elemento no existe","Error",0);
        //}
